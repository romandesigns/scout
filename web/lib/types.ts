export type Finding = {
  ...
  candidate_profile?: { velocity?:number|null; participation?:number|null; structure?:number|null; catalyst?:number|null; quality?:number|null; supply?:number|null; multi_timeframe?: { qualified?:boolean; gates?:Record<string,boolean>; blockers?:string[]; five_minute_samples?:number; five_minute_change_pct?:number; one_minute_change_pct?:number; one_minute_higher_low_ratio?:number; change_30s_pct?:number; fast_tape_veto?:boolean }; decision_chart?: { primary_seconds?:15|30|60|300; trigger_seconds?:15|30|60|300; context_seconds?:15|30|60|300; instruction?:string }; promotion_trace?: { gates?: Record<string, boolean>; blockers?: string[]; next_blocker?: string | null }; box?: { low?:number; high?:number; width_pct?:number; breakout?:boolean; holding?:boolean; quality?:number }; edge_validation?: { status?:"PROFIT_VALIDATED"|"EVALUATING"; validated?:boolean; cohort?:string; samples?:number; minimum_samples?:number; wins?:number; win_rate?:number|null; wilson_lower?:number|null; break_even_rate?:number; average_r?:number|null }; imminent_move_gate?: { status?:string; shadow_only?:boolean; probability?:number; threshold?:number; would_pass?:boolean; model_test_date?:string; error?:string } };
  episode_id?: number;
...
export type FindingVerification = {
  ...
  review?:{user_grade?:number|null;user_agrees?:boolean|null;reason_tags?:string[];notes?:string;reviewed_at?:number|null;gate_feedback?:string|null}|null;
};
